...
/**
 * <p>
 * Class for testing the histogram without the robot
 * </p>
 * 
...
public class HistogramTest {
    ...
    /**
     * <p>
     * Gets an rss VisualServo.Image type of image from the given BufferedImage.
     * </p>
     * 
     * @param image
     *            BufferedImage to convert to a VisualServo.Image
    ...
    public static Image getRSSImage(BufferedImage image) {
        ...
        System.out.println("BufferedImage.getRSSImage input width: " + width
                + " height: " + height);
    ...
    /**
     * <p>
     * Gets a BufferedImage from an rss VisualServo.Image
     * </p>
     * 
     * @param image
     *            rss image
    ...
    public static BufferedImage getBufferedImage(Image image) {
        ...
        System.out.println("BufferedImage.getBufferedImage input width: "
                + width + " height: " + height);
    ...
    /**
     * <p>
     * Just read in the image passed image and the desired output image
     * </p>
     **/
    public static void main(String[] arg) {
        if (arg.length != 2) {
            System.out
                    .println("Usage: java VisualServo.HistogramTest inimage outimage");
            System.exit(1);
        }
        ...
        try {
            ...
            // Now ouput it
            BufferedImage outputImage = HistogramTest
                    .getBufferedImage(rssImage);
